...
import 'package:testapp1/AdminPages/AdminScreen_ar.dart';

import '../landingpage.dart';

class AdminProfilePageAR extends StatefulWidget {
  const AdminProfilePageAR({super.key});

  @override
  State<AdminProfilePageAR> createState() => _AdminProfilePageARState();
}

class _AdminProfilePageARState extends State<AdminProfilePageAR> {
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const AdminScreenAR()),
                  );
                },
                child: Padding(
                  padding:
